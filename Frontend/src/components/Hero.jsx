...
const Hero = ({ isVisible }) => {
  return (
    <section id="hero" className="section min-h-screen flex items-center justify-center relative overflow-hidden bg-gradient-to-br from-slate-900 via-gray-900 to-blue-900">
      ...
      <div className="relative z-10 text-center max-w-4xl mx-auto px-6">
        <div className="animate-on-scroll" id="hero-content">
          <h1 className={`text-5xl md:text-7xl font-bold mb-8 leading-tight transition-all duration-1000 ${
          ...
          <p className={`text-xl md:text-2xl text-gray-300 mb-12 transition-all duration-1000 delay-300 ${
            isVisible['hero-content'] ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
          }`}>
            The future of collaborative workspaces. Where productivity meets innovation.
          </p>
          <div className={`flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-6 transition-all duration-1000 delay-600 ${
            isVisible['hero-content'] ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
          }`}>
            ...
            <button className="border border-purple-400 px-8 py-4 rounded-lg text-lg font-semibold hover:bg-purple-600/20 transition-all duration-300">
              Learn More
            </button>
          </div>
        </div>
